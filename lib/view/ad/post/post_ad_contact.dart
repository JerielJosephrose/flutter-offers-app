...
import 'post_ad_confirm.dart';

class PostAdContact extends StatefulWidget {
  ...
  @override
  PostAdContactState createState() => new PostAdContactState(
      this.id,
      this.latitude,
      this.longitude,
      this.date,
...
class PostAdContactState extends State<PostAdContact> {
  final String contentjson;
  final int id;
  final String latitude;
  final String longitude;
  ...
  PostAdContactState(this.id, this.latitude, this.longitude, this.date,
      this.contentjson, this.scontact);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Choisir un moyen de contact'),
  ...
  void navigateToDetail(String value, Contact contact, String title) async {
    bool result = await Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => DetailContact(value, contact, title)));
    if (result == true) {
      updateContactList();
    }
  }
  ...
  void updateContactList() {
    ContactValue Phone =
        ContactValue('Numéro de téléphone', Image.asset("images/phone.png"));
    ContactValue Email =
        ContactValue('Adresse email', Image.asset("images/email.png"));
    ContactValue Facebook =
        ContactValue('Facebook', Image.asset("images/facebook.png"));
    ContactValue Skype = ContactValue('Skype', Image.asset("images/skype.png"));
    ContactValue Instagram =
        ContactValue('Compte instagram', Image.asset("images/instagram.png"));
    ContactValue Linkedin =
        ContactValue('Linkedin', Image.asset("images/linkedin.png"));
    ContactValue Twitter =
        ContactValue('Twitter', Image.asset("images/twit.png"));
    ...
    return ListView.separated(
      ...
      itemBuilder: (BuildContext context, int index) {
        return GestureDetector(
          child: ListTile(
              leading: myContacts[index].imageicon,
              title: Text(myContacts[index].title.toString() +
                  ": " +
                  myContacts[index].value.toString())),
          onTap: () {
            String selectedContact =
                myContacts[index].title + ": " + myContacts[index].value;
            openConfirm(
                id, contentjson, latitude, longitude, date, selectedContact);
          },
        );
      },
